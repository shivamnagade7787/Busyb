                ...
                <tr key={party.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td className="p-4 flex items-center justify-end gap-2">
                    ...
                    {party.balance > 0 && party.mobile && (
                      <a 
                        href={`https://wa.me/${party.mobile}?text=Hi ${party.name}, this is a gentle reminder for your pending payment of ${formatCurrency(party.balance)}. Please clear it at your earliest convenience.`}
                        target="_blank"
