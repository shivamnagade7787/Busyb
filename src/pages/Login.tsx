  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/user-not-found' || err.code === 'auth/wrong-password' || err.code === 'auth/invalid-credential') {
        ...
        setError('Email/Password sign-in is not enabled. Please enable it in your Firebase Console under Authentication > Sign-in method, or use Google Sign-In below.');
      } else {
